...
Goldbear now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<goldbear_address\> \<monthly_payment_goldbear\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ GOLDBEAR, _12_ times over the course of a year totaling _24000_ GOLDBEAR.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<goldbear_address\> \<monthly_payment_goldbear\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` GOLDBEAR.
 ...
 * vote-many          - Vote on a Goldbear initiative
 * vote-alias         - Vote on a Goldbear initiative
 * vote               - Vote on a Goldbear initiative/budget
