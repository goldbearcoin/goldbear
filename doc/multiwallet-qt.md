...
In order to support loading of multiple wallets in goldbear-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is goldbear.cpp.
...
Changes to goldbear.cpp
----------------------
goldbear.cpp is the entry point into goldbear-qt, and as such, will require some minor modifications to provide hooks for
