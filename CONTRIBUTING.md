Contributing to Goldbear
============================

The Goldbear project operates an open contributor model where anyone is
...
The following applies to code changes to the Goldbear project, and is not to be
confused with overall GOLDBEAR Network Protocol consensus changes.

Whether a pull request is merged into Goldbear rests with the project merge
...
Patches that change GOLDBEAR consensus rules are considerably more involved than
...
Where a patch set proposes to change the GOLDBEAR consensus, it must have been
...
The project leader is the release manager for each Goldbear release.
