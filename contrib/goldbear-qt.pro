...
RESOURCES += src/qt/goldbear.qrc src/qt/goldbear_locale.qrc

TRANSLATIONS += src/qt/locale/goldbear_bg.ts \
                src/qt/locale/goldbear_de.ts \
                src/qt/locale/goldbear_en.ts \
                src/qt/locale/goldbear_es.ts \
                src/qt/locale/goldbear_fi.ts \
                src/qt/locale/goldbear_fr.ts \
                src/qt/locale/goldbear_it.ts \
                src/qt/locale/goldbear_ja.ts \
                src/qt/locale/goldbear_pl.ts \
                src/qt/locale/goldbear_pt.ts \
                src/qt/locale/goldbear_ru.ts \
                src/qt/locale/goldbear_sk.ts \
                src/qt/locale/goldbear_sv.ts \
                src/qt/locale/goldbear_vi.ts \
                src/qt/locale/goldbear_zh_CN.ts \
                src/qt/locale/goldbear_zh_TW.ts
