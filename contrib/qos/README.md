...
This means one can have an always-on goldbeard instance running, and another local goldbeard/goldbear-qt instance which connects to this node and receives blocks from it.
