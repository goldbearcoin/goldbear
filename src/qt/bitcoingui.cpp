                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Goldbear") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GOLDBEAR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and goldbear: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Goldbear"), this);
    aboutAction->setStatusTip(tr("Show information about Goldbear"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GOLDBEAR"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GOLDBEAR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GOLDBEAR addresses"));
    ...
    openAction->setStatusTip(tr("Open a GOLDBEAR: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Goldbear help message to get a list with possible GOLDBEAR command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Goldbear client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GOLDBEAR network", "", count));
}
...
{
    QString strTitle = tr("Goldbear"); // default title
