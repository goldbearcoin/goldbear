...
/** Utility functions used by the GOLDBEAR Qt UI.
 */
namespace GUIUtil
{
...
// Render GOLDBEAR addresses in monospace font
...
// Parse "goldbear:" URI into recipient object, return true on successful parsing
