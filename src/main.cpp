...
#if defined(NDEBUG)
#error "GOLDBEAR cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    } else if (nHeight >= 2 && nHeight <= 3300) {
      nSubsidy = 10 * COIN;
    } else if (nHeight >= 3301 && nHeight <= 39500) {
      nSubsidy = 90 * COIN;
    } else if (nHeight >= 39501 && nHeight <= 102500) {
      nSubsidy = 115 * COIN;
    } else if (nHeight >= 102501 && nHeight <= 204400) {
      nSubsidy = 65 * COIN;
    } else if (nHeight >= 204401 && nHeight <= 416400) {
      nSubsidy = 45 * COIN;
    } else if (nHeight >= 416401 && nHeight <= 836700) {
      nSubsidy = 15 * COIN;
    } else if (nHeight >= 836701) {
      nSubsidy = 10 * COIN;
    }
...
{
    RenameThread("goldbear-scriptch");
