...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Goldbear goldbear-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  goldbear-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded goldbear transaction") + "\n" +
                               "  goldbear-tx [options] -create [commands]   " + _("Create hex-encoded goldbear transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded goldbear transaction
