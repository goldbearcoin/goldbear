...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop GOLDBEAR server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "GOLDBEAR server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Goldbear features */
        {"goldbear", "masternode", &masternode, true, true, false},
        {"goldbear", "listmasternodes", &listmasternodes, true, true, false},
        {"goldbear", "getmasternodecount", &getmasternodecount, true, true, false},
        {"goldbear", "masternodeconnect", &masternodeconnect, true, true, false},
        {"goldbear", "masternodecurrent", &masternodecurrent, true, true, false},
        {"goldbear", "masternodedebug", &masternodedebug, true, true, false},
        {"goldbear", "startmasternode", &startmasternode, true, true, false},
        {"goldbear", "createmasternodekey", &createmasternodekey, true, true, false},
        {"goldbear", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"goldbear", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"goldbear", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"goldbear", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"goldbear", "getmasternodescores", &getmasternodescores, true, true, false},
        {"goldbear", "mnbudget", &mnbudget, true, true, false},
        {"goldbear", "preparebudget", &preparebudget, true, true, false},
        {"goldbear", "submitbudget", &submitbudget, true, true, false},
        {"goldbear", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"goldbear", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"goldbear", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"goldbear", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"goldbear", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"goldbear", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"goldbear", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"goldbear", "checkbudgets", &checkbudgets, true, true, false},
        {"goldbear", "mnsync", &mnsync, true, true, false},
        {"goldbear", "spork", &spork, true, true, false},
        {"goldbear", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"goldbear", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use goldbeard, or the -server option to goldbear-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> goldbear-cli " + methodname + " " + args + "\n";
}
