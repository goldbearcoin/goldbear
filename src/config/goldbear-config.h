/* src/config/goldbear-config.h.  Generated from goldbear-config.h.in by configure.  */
/* src/config/goldbear-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Goldbear_CONFIG_H

#define Goldbear_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.goldbear.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Goldbear Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Goldbear Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "goldbear"
